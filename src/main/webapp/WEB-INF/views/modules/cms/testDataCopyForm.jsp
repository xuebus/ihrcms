...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/testDataCopy/">TESTDATACOPY列表</a></li>
		<li class="active"><a href="${ctx}/cms/testDataCopy/form?id=${testDataCopy.id}">TESTDATACOPY<shiro:hasPermission name="cms:testDataCopy:edit">${not empty testDataCopy.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:testDataCopy:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testDataCopy" action="${ctx}/cms/testDataCopy/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="cms:testDataCopy:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
